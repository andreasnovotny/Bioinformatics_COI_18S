...
# Rather save the individual components.

saveRDS(Taxtab_COI_tmp, "Data_export/COI/Taxtab_COI.rds")
saveRDS(ASV_COI_tmp, "Data_export/COI/ASV_COI.rds")
saveRDS(Samptab_COI_tmp, "Data_export/COI/Samptab_COI.rds")
```
...
write_tsv(df_18S, "ProcessedData/18S_Andreas/18S_Hakai_AN.txt")
