...
# Upload each component to the cloud:
saveRDS(Taxtab_COI_tmp, "Data_export/Taxtab_COI.rds")
drive_rm("Data_Novotny/Taxtab_COI.rds")
drive_upload("Data_export/Taxtab_COI.rds", "Data_Novotny/Taxtab_COI.rds")

saveRDS(ASV_COI_tmp, "Data_export/ASV_COI.rds")
drive_rm("Data_Novotny/ASV_COI.rds")
drive_upload("Data_export/ASV_COI.rds", "Data_Novotny/ASV_COI.rds")

saveRDS(Samptab_COI_tmp, "Data_export/Samptab_COI.rds")
drive_rm("Data_Novotny/Samptab_COI.rds")
drive_upload("Data_export/Samptab_COI.rds", "Data_Novotny/Samptab_COI.rds")
...
```{r}
Taxtab_18S_tmp <- readRDS("ProcessedData/18S_Andreas/tax_tab_18S.RDS")$tax %>%
  as.data.frame() %>% 
...
Taxtab_18S_tmp <- readRDS("ProcessedData/18S_Andreas/tax_tab_18S_SILVA.RDS")$tax %>% 
  as.data.frame() %>% 
  rownames_to_column("Sequence") %>% 
  filter(is.na(Genus)==FALSE)

Taxtab_18S_tmp %>% 
  filter(Family == "Calanoida") %>% 
  pull(Genus) %>% unique
...
saveRDS(Taxtab_18S_tmp, "Data_export/Taxtab_18S.rds")
drive_rm("Data_Novotny/Taxtab_18S.rds")
drive_upload("Data_export/Taxtab_18S.rds", "Data_Novotny/Taxtab_18S.rds")

saveRDS(ASV_18S_tmp, "Data_export/ASV_18S.rds")
drive_rm("Data_Novotny/ASV_18S.rds")
drive_upload("Data_export/ASV_18S.rds", "Data_Novotny/ASV_18S.rds")

saveRDS(Samptab_18S_tmp, "Data_export/Samptab_18S.rds")
drive_rm("Data_Novotny/Samptab_18S.rds")
drive_upload("Data_export/Samptab_18S.rds", "Data_Novotny/Samptab_18S.rds")
...
drive_rm("Data_Novotny/Taxtab_12S.rds")
drive_upload("Data_export/Taxtab_12S.rds", "Data_Novotny/Taxtab_12S.rds")

saveRDS(ASV_12S_tmp, "Data_export/ASV_12S.rds")
drive_rm("Data_Novotny/ASV_12S.rds")
drive_upload("Data_export/ASV_12S.rds", "Data_Novotny/ASV_12S.rds")

saveRDS(Samptab_12S_tmp, "Data_export/Samptab_12S.rds")
drive_rm("Data_Novotny/Samptab_12S.rds")
drive_upload("Data_export/Samptab_12S.rds", "Data_Novotny/Samptab_12S.rds")
