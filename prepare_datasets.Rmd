...
### Taxonomy Table
#### TODO: FIX 18S rds format
```{r}
  Taxtab_18S_tmp <- read.delim( "ProcessedData/12S_Andreas/Taxonomy/taxonomy_table.12S.NCBI_NT.96sim.LCA+besthit.txt") %>% 
  rename_with(~gsub(., pattern = "X.", replacement = "")) %>% 
  rename(ASV = Query)
Taxtab_12S_tmp
```
